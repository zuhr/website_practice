...
u.prototype.start=function(){this.u=!1;if(0==this.b)switch(this.j=y(this),this.j){case 1:var a=this.C;this.b=this.B?window.requestIdleCallback(a,{timeout:3E3}):window.setTimeout(a,300);break;case 2:this.b=window.setTimeout(this.F,this.G);break;case 3:this.b=window.requestAnimationFrame(this.D)}};
function z(a){if(a.b){switch(a.j){case 1:var b=a.b;a.B?window.cancelIdleCallback(b):window.clearTimeout(b);break;case 2:window.clearTimeout(a.b);break;case 3:window.cancelAnimationFrame(a.b)}a.b=0}}
u.prototype.o=function(){A(this);z(this);this.w&&document.removeEventListener("visibilitychange",this.A);u.M.o.call(this)};function C(){var a=g("yt.scheduler.instance.instance_");if(!a||a.isDisposed())a=new u(("scheduler"in q?q.scheduler:void 0)||{}),n("yt.scheduler.instance.instance_",a);return a}
